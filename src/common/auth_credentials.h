...
#define QL_STEAM_WEB_API_AUTH_TICKET_MAX_LENGTH 2560
#define QL_STEAM_WEB_API_AUTH_TICKET_HEX_LENGTH (QL_STEAM_WEB_API_AUTH_TICKET_MAX_LENGTH * 2 + 1)
#define QL_AUTH_MAX_CREDENTIAL_LENGTH QL_STEAM_WEB_API_AUTH_TICKET_HEX_LENGTH
