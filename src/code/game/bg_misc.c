...
static const int bg_weaponMaxAmmo[WP_NUM_WEAPONS] = {
	...
	[WP_MACHINEGUN] = 200,
	[WP_SHOTGUN] = 40,
	[WP_GRENADE_LAUNCHER] = 20,
	[WP_ROCKET_LAUNCHER] = 20,
	[WP_LIGHTNING] = 240,
	[WP_RAILGUN] = 40,
	[WP_PLASMAGUN] = 120,
	[WP_BFG] = 60,
...
static const int bg_weaponToItemTag[WP_NUM_WEAPONS] = {
	[WP_NONE] = 0,
	[WP_GAUNTLET] = ITEMTAG_WEAPON_GAUNTLET,
	[WP_MACHINEGUN] = ITEMTAG_WEAPON_MACHINEGUN,
	[WP_SHOTGUN] = ITEMTAG_WEAPON_SHOTGUN,
	[WP_GRENADE_LAUNCHER] = ITEMTAG_WEAPON_GRENADE_LAUNCHER,
	[WP_ROCKET_LAUNCHER] = ITEMTAG_WEAPON_ROCKET_LAUNCHER,
	[WP_LIGHTNING] = ITEMTAG_WEAPON_LIGHTNING,
	[WP_RAILGUN] = ITEMTAG_WEAPON_RAILGUN,
	[WP_PLASMAGUN] = ITEMTAG_WEAPON_PLASMAGUN,
	[WP_BFG] = ITEMTAG_WEAPON_BFG,
	[WP_GRAPPLING_HOOK] = ITEMTAG_WEAPON_GRAPPLING_HOOK,
	[WP_NAILGUN] = ITEMTAG_WEAPON_NAILGUN,
	[WP_PROX_LAUNCHER] = ITEMTAG_WEAPON_PROX_LAUNCHER,
	[WP_CHAINGUN] = ITEMTAG_WEAPON_CHAINGUN,
	[WP_HEAVY_MACHINEGUN] = ITEMTAG_WEAPON_HEAVY_MACHINEGUN
};
...
Returns qtrue when retail weapon-stay behavior is active for server world
weapon pickups.
=============
*/
...
weapons stay pickupable, and client prediction otherwise follows the tiny
retail cgame leaf that only permits missing weapons or zero-ammo regrabs.
=============
*/
