...
void Cmd_CallVote_f( gentity_t *ent ) {
	...
	if ( !Q_stricmp( arg1, "map_restart" ) ) {
		...
		Com_sprintf( level.voteString, sizeof( level.voteString ), "g_thruFloors %d", atoi( arg2 ) );
		...
		trap_SendServerCommand( ent-g_entities, "print \"Invalid vote string.\\n\"" );
		trap_SendServerCommand( ent-g_entities, "print \"Vote commands are: map_restart, nextmap, map <mapname>, g_gametype <n>, kick <player>, clientkick <clientnum>, g_doWarmup, timelimit <time>, fraglimit <frags>, elo <rating>, thrufloors <0/1>, instagib <0/1>, loadouts <0/1>, teamdamage <0/1>.\\n\"" );
		return;
	}
