...
#define INVENTORY_HEAVYMACHINEGUN	 12
...
#define INVENTORY_HEAVYBULLETS		 50
#define INVENTORY_KEY_SILVER		 51
#define INVENTORY_KEY_GOLD		 52
#define INVENTORY_KEY_MASTER		 53
//enemy stuff
