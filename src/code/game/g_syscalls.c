...
static int G_MapNativeImport( int arg, const intptr_t *stack ) {
	...
	case G_IN_PVS_IGNORE_PORTALS: return G_QL_IMPORT_IN_PVS_IGNORE_PORTALS;
	case G_ADJUST_AREA_PORTAL_STATE: return G_QL_IMPORT_ADJUST_AREA_PORTAL_STATE;
	case G_AREAS_CONNECTED: return G_QL_IMPORT_AREAS_CONNECTED;
	...
	case G_ENTITY_CONTACT: return G_QL_IMPORT_ENTITY_CONTACT;
	case G_BOT_ALLOCATE_CLIENT: return G_QL_IMPORT_BOT_ALLOCATE_CLIENT;
	case G_BOT_FREE_CLIENT: return G_QL_IMPORT_BOT_FREE_CLIENT;
	case G_GET_USERCMD: return G_QL_IMPORT_GET_USERCMD;
	case G_GET_ENTITY_TOKEN: return G_QL_IMPORT_GET_ENTITY_TOKEN;
	case G_DEBUG_POLYGON_CREATE: return G_QL_IMPORT_DEBUG_POLYGON_CREATE;
	case G_DEBUG_POLYGON_DELETE: return G_QL_IMPORT_DEBUG_POLYGON_DELETE;
	...
	case BOTLIB_LIBVAR_GET: return G_QL_IMPORT_BOTLIB_LIBVAR_GET;
	...
	case BOTLIB_TEST: return G_QL_IMPORT_BOTLIB_TEST;
	...
	case BOTLIB_EA_SAY_TEAM: return G_QL_IMPORT_BOTLIB_EA_SAY_TEAM;
	...
	case BOTLIB_EA_TALK: return G_QL_IMPORT_BOTLIB_EA_TALK;
	case BOTLIB_EA_ATTACK: return G_QL_IMPORT_BOTLIB_EA_ATTACK;
	case BOTLIB_EA_USE: return G_QL_IMPORT_BOTLIB_EA_USE;
	case BOTLIB_EA_RESPAWN: return G_QL_IMPORT_BOTLIB_EA_RESPAWN;
	case BOTLIB_EA_CROUCH: return G_QL_IMPORT_BOTLIB_EA_CROUCH;
	case BOTLIB_EA_MOVE_UP: return G_QL_IMPORT_BOTLIB_EA_MOVE_UP;
	case BOTLIB_EA_MOVE_DOWN: return G_QL_IMPORT_BOTLIB_EA_MOVE_DOWN;
	case BOTLIB_EA_MOVE_FORWARD: return G_QL_IMPORT_BOTLIB_EA_MOVE_FORWARD;
	case BOTLIB_EA_MOVE_BACK: return G_QL_IMPORT_BOTLIB_EA_MOVE_BACK;
	case BOTLIB_EA_MOVE_LEFT: return G_QL_IMPORT_BOTLIB_EA_MOVE_LEFT;
	case BOTLIB_EA_MOVE_RIGHT: return G_QL_IMPORT_BOTLIB_EA_MOVE_RIGHT;
	case BOTLIB_EA_SELECT_WEAPON: return G_QL_IMPORT_BOTLIB_EA_SELECT_WEAPON;
	case BOTLIB_EA_JUMP: return G_QL_IMPORT_BOTLIB_EA_JUMP;
	case BOTLIB_EA_DELAYED_JUMP: return G_QL_IMPORT_BOTLIB_EA_DELAYED_JUMP;
	case BOTLIB_EA_MOVE: return G_QL_IMPORT_BOTLIB_EA_MOVE;
	...
	case BOTLIB_AI_FREE_CHARACTER: return G_QL_IMPORT_BOTLIB_AI_FREE_CHARACTER;
	case BOTLIB_AI_CHARACTERISTIC_FLOAT: return G_QL_IMPORT_BOTLIB_AI_CHARACTERISTIC_FLOAT;
	case BOTLIB_AI_CHARACTERISTIC_BFLOAT: return G_QL_IMPORT_BOTLIB_AI_CHARACTERISTIC_BFLOAT;
	case BOTLIB_AI_CHARACTERISTIC_INTEGER: return G_QL_IMPORT_BOTLIB_AI_CHARACTERISTIC_INTEGER;
	...
	case BOTLIB_AI_REMOVE_CONSOLE_MESSAGE: return G_QL_IMPORT_BOTLIB_AI_REMOVE_CONSOLE_MESSAGE;
	...
	case BOTLIB_AI_GET_MAP_LOCATION_GOAL: return G_QL_IMPORT_BOTLIB_AI_GET_MAP_LOCATION_GOAL;
	...
	case BOTLIB_AI_INIT_LEVEL_ITEMS: return G_QL_IMPORT_BOTLIB_AI_INIT_LEVEL_ITEMS;
	case BOTLIB_AI_UPDATE_ENTITY_ITEMS: return G_QL_IMPORT_BOTLIB_AI_UPDATE_ENTITY_ITEMS;
	case BOTLIB_AI_LOAD_ITEM_WEIGHTS: return G_QL_IMPORT_BOTLIB_AI_LOAD_ITEM_WEIGHTS;
	case BOTLIB_AI_FREE_ITEM_WEIGHTS: return G_QL_IMPORT_BOTLIB_AI_FREE_ITEM_WEIGHTS;
	case BOTLIB_AI_INTERBREED_GOAL_FUZZY_LOGIC: return G_QL_IMPORT_BOTLIB_AI_INTERBREED_GOAL_FUZZY_LOGIC;
	case BOTLIB_AI_SAVE_GOAL_FUZZY_LOGIC: return G_QL_IMPORT_BOTLIB_AI_SAVE_GOAL_FUZZY_LOGIC;
	case BOTLIB_AI_MUTATE_GOAL_FUZZY_LOGIC: return G_QL_IMPORT_BOTLIB_AI_MUTATE_GOAL_FUZZY_LOGIC;
	case BOTLIB_AI_ALLOC_GOAL_STATE: return G_QL_IMPORT_BOTLIB_AI_ALLOC_GOAL_STATE;
	case BOTLIB_AI_FREE_GOAL_STATE: return G_QL_IMPORT_BOTLIB_AI_FREE_GOAL_STATE;
	...
	case BOTLIB_AI_REACHABILITY_AREA: return G_QL_IMPORT_BOTLIB_AI_REACHABILITY_AREA;
	...
	case BOTLIB_AI_FREE_MOVE_STATE: return G_QL_IMPORT_BOTLIB_AI_FREE_MOVE_STATE;
...
Queries the retail host factory registry through native import slot 206.
=============
*/
qboolean trap_FactoryExists( const char *id ) {
	ql_import_f import = G_GetDirectImport( G_QL_IMPORT_FACTORY_EXISTS );

	if ( !import ) {
		return qfalse;
	}

	return ((int (QDECL *)( const char * ))import)( id ) ? qtrue : qfalse;
}

/*
=============
trap_GenerateMatchGuid

Requests the retail match GUID generator through native import slot 202.
=============
*/
void trap_GenerateMatchGuid( char *buffer, int bufferSize ) {
	ql_import_f import = G_GetDirectImport( G_QL_IMPORT_GENERATE_MATCH_GUID );
	...
	((void (QDECL *)( char *, int ))import)( buffer, bufferSize );
}
...
/*
=================
trap_BotDrawDebugAreas
=================
*/
void trap_BotDrawDebugAreas(vec3_t origin, int enable, int areanum) {
	ql_import_f import = G_GetDirectImport( G_QL_IMPORT_BOTLIB_AI_DRAW_DEBUG_AREAS );

	if ( import ) {
		((void (QDECL *)( vec3_t, int, int ))import)( origin, enable, areanum );
	}
}

/*
=================
trap_BotDrawAvoidSpots
=================
*/
void trap_BotDrawAvoidSpots(int movestate) {
	ql_import_f import = G_GetDirectImport( G_QL_IMPORT_BOTLIB_AI_DRAW_AVOID_SPOTS );

	if ( import ) {
		((void (QDECL *)( int ))import)( movestate );
	}
}
