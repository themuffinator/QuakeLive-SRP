...
typedef struct {
	...
	const char		*getInfoCommand;
	const char		*infoResponseCommand;
	const char		*getStatusCommand;
	const char		*statusResponseCommand;
	const char		*disconnectCommand;
	const char		*printCommand;
	const char		*echoCommand;
	const char		*rconCommand;
	const char		*getServersCommand;
	const char		*serversResponseCommand;
	const char		*getMotdCommand;
	const char		*motdResponseCommand;
	const char		*getKeyAuthorizeCommand;
	const char		*keyAuthorizeResponseCommand;
	const char		*getIpAuthorizeCommand;
	const char		*ipAuthorizeResponseCommand;
	const char		*heartbeatCommand;
	const char		*heartbeatGameName;
	const char		*downloadCommand;
	const char		*nextDownloadCommand;
	const char		*stopDownloadCommand;
	const char		*doneDownloadCommand;
	const char		*pureChecksumsCommand;
	const char		*encodedPureChecksumsCommand;
	const char		*pureResetCommand;
	...
	const char		*motdChallengeInfoKey;
	const char		*motdInfoKey;
	const char		*motdRendererInfoKey;
	const char		*motdVersionInfoKey;
	const char		*hostnameInfoKey;
	const char		*mapnameInfoKey;
	const char		*clientsInfoKey;
	const char		*botPlayersInfoKey;
	const char		*vacInfoKey;
	const char		*serverTypeInfoKey;
	const char		*maxClientsInfoKey;
	const char		*gametypeInfoKey;
	const char		*pureInfoKey;
	const char		*minPingInfoKey;
	const char		*maxPingInfoKey;
	const char		*pingInfoKey;
	const char		*legacyMinPingInfoKey;
	const char		*legacyMaxPingInfoKey;
	const char		*gameInfoKey;
	const char		*netTypeInfoKey;
	const char		*addressInfoKey;
	const char		*punkbusterInfoKey;
	const char		*keywordsInfoKey;
	const char		*clientIpInfoKey;
	const char		*passwordInfoKey;
	const char		*nameInfoKey;
	const char		*rateInfoKey;
	const char		*handicapInfoKey;
	const char		*snapsInfoKey;
	const char		*serverIdInfoKey;
	const char		*cheatsInfoKey;
	const char		*paksInfoKey;
	const char		*pakNamesInfoKey;
	const char		*referencedPaksInfoKey;
	const char		*referencedPakNamesInfoKey;
	const char		*fsGameInfoKey;
	const char		*systemPureInfoKey;
	int				connectProtocol;
	int				demoProtocol;
