...
| `sub_465B70` (`0x00465B70`) | **`SteamServerCallbacks_OnP2PSessionRequest`** | Accepts P2P sessions only when the connecting Steam ID matches a live authenticated client【932230678200358†L142-L149】. |
