...
| `0x004F2900` | `QLWebView_InjectActivationKeyboardEvent` | Closed by round 285 alias promotion and the 2026-05-24 source-visible `WebKeyboardEvent(0, 0x11, 0x1d0001)` field model |
