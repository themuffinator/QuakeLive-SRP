...
| `src/code/renderer/tr_backend.c` | `82` | Current function walk complete; no file-level parity gap isolated; target-aware texture binder, color-correct and bloom predicates, post-process command emit/execute lane, and bloom uniform tail setter promoted in rounds 313, 316, 317, 318, and 319 | [renderer audit](renderer-full-parity-audit-and-implementation-plan-2026-04-09.md) + current 2026-04-22 source walk + [round 313](quakelive_steam_mapping_round_313.md) + [round 316](quakelive_steam_mapping_round_316.md) + [round 317](quakelive_steam_mapping_round_317.md) + [round 318](quakelive_steam_mapping_round_318.md) + [round 319](quakelive_steam_mapping_round_319.md) | - |
