...
| `src/code/game/g_active.c` | `65` | 2026-05-23 exit-rule re-audit tightened the CA/Freeze shared checker against qagame `0x1004C070`: roundlimit now follows the retail red-first/blue-second threshold order after the tie gate, and the mercylimit window routes through the shared overtime-adjusted limit helper. | [module audit](game-module-parity-audit-and-implementation-plan-2026-04-10.md) + current 2026-05-23 source walk | - |
...
| `src/code/game/g_team.c` | `143` | 2026-05-23 exit-rule re-audit tightened `G_ADCheckExitRules` against qagame `0x10035A20`, preserving the retail overtime-adjusted mercy window while leaving the A/D timelimit, scorelimit, and print/log ordering intact. | [module audit](game-module-parity-audit-and-implementation-plan-2026-04-10.md) + current 2026-05-23 source walk | - |
...
| `src/code/renderer/tr_backend.c` | `79` | Current function walk complete; no file-level parity gap isolated; target-aware texture binder, color-correct and bloom predicates, post-process command emit/execute lane with queued texture/program payload consumption, bloom uniform tail setter, retail combine-uniform slot order, color-correct uniform helper, live helper export surface, init/live browser override split, single rectangle-texture framebuffer owner, grouped bloom teardown ordering, depth-stencil renderbuffer cache, post-effect link helper, and split framebuffer/shader procedure gates promoted in rounds 313, 316, 317, 318, 319, 320, 321, 322, 323, 324, 325, 326, 327, 328, and 341 | [renderer audit](renderer-full-parity-audit-and-implementation-plan-2026-04-09.md) + current 2026-04-22 source walk + [round 313](quakelive_steam_mapping_round_313.md) + [round 316](quakelive_steam_mapping_round_316.md) + [round 317](quakelive_steam_mapping_round_317.md) + [round 318](quakelive_steam_mapping_round_318.md) + [round 319](quakelive_steam_mapping_round_319.md) + [round 320](quakelive_steam_mapping_round_320.md) + [round 321](quakelive_steam_mapping_round_321.md) + [round 322](quakelive_steam_mapping_round_322.md) + [round 323](quakelive_steam_mapping_round_323.md) + [round 324](quakelive_steam_mapping_round_324.md) + [round 325](quakelive_steam_mapping_round_325.md) + [round 326](quakelive_steam_mapping_round_326.md) + [round 327](quakelive_steam_mapping_round_327.md) + [round 328](quakelive_steam_mapping_round_328.md) + [round 341](quakelive_steam_mapping_round_341.md) | - |
...
| `src/code/renderer/tr_cmds.c` | `13` | Current function walk complete; no file-level parity gap isolated; frame-begin live post-process cvar modified-latch refresh promoted in round 322 | [renderer audit](renderer-full-parity-audit-and-implementation-plan-2026-04-09.md) + current 2026-04-22 source walk + [round 322](quakelive_steam_mapping_round_322.md) | - |
...
| `src/code/renderer/tr_image.c` | `58` | Current function walk complete; no file-level parity gap isolated; image-constructor, memory-loader, diagnostic, hash-helper, and upload-color edge details rechecked in rounds 312-316 | [renderer audit](renderer-full-parity-audit-and-implementation-plan-2026-04-09.md) + current 2026-04-22 source walk + [round 312](quakelive_steam_mapping_round_312.md) + [round 313](quakelive_steam_mapping_round_313.md) + [round 314](quakelive_steam_mapping_round_314.md) + [round 315](quakelive_steam_mapping_round_315.md) + [round 316](quakelive_steam_mapping_round_316.md) | - |
| `src/code/renderer/tr_init.c` | `30` | Current function walk complete; no file-level parity gap isolated; post-process enable/restart cvar state kept separate from the live frame-begin modified-latch refresh in round 322; return-valued `GL_CheckErrors` contract restored in round 327 | [renderer audit](renderer-full-parity-audit-and-implementation-plan-2026-04-09.md) + current 2026-04-22 source walk + [round 322](quakelive_steam_mapping_round_322.md) + [round 327](quakelive_steam_mapping_round_327.md) | - |
