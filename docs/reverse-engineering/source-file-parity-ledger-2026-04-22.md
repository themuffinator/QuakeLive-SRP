...
| `src/code/renderer/tr_backend.c` | `74` | Current function walk complete; no file-level parity gap isolated; target-aware texture binder promoted in round 313 | [renderer audit](renderer-full-parity-audit-and-implementation-plan-2026-04-09.md) + current 2026-04-22 source walk + [round 313](quakelive_steam_mapping_round_313.md) | - |
...
| `src/code/renderer/tr_image.c` | `58` | Current function walk complete; no file-level parity gap isolated; image-constructor, memory-loader, diagnostic, hash-helper, and upload-color edge details rechecked in rounds 312-315 | [renderer audit](renderer-full-parity-audit-and-implementation-plan-2026-04-09.md) + current 2026-04-22 source walk + [round 312](quakelive_steam_mapping_round_312.md) + [round 313](quakelive_steam_mapping_round_313.md) + [round 314](quakelive_steam_mapping_round_314.md) + [round 315](quakelive_steam_mapping_round_315.md) | - |
