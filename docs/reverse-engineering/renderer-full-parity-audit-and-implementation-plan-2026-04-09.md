...
- `RG-G03` stays closed. The shader-backed post-process family, recovered `r_contrast` lane, command-buffer ABI, and private refexport tail for color-correct, bloom, scene-target binding, and bloom uniform setting remain in writable source.
