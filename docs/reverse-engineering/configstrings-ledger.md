...
| `0x296` | `CS_ROUND_START_TIME` | Hidden active-round start timestamp published at the retail round-active transition for the `CG_ROUNDTIMER` final-second countdown. | `F:references/hlil/quakelive/qagamex86.dll/qagamex86.dll.bndb_hlil_split/qagamex86.dll.bndb_hlil_part01.txt†L36961-L36974`, `F:references/hlil/quakelive/cgamex86.dll/cgamex86.dll_hlil_split/cgamex86.dll_hlil_part01.txt†L35134-L35160` |
...
| `0x2C7` | `CS_LOADOUT_FLAGS` | Decimal bitmask describing which loadout choices (`g_disableLoadout`, map restrictions, etc.) are disabled while loadouts are enabled. | `F:references/hlil/quakelive/qagamex86.dll/qagamex86.dll.bndb_hlil_split/qagamex86.dll.bndb_hlil_part02.txt†L23218-L23234` |
| `0x2C9` | `CS_LOADOUT_MASK` | Decimal starting-weapon mask consumed by `CG_STARTING_WEAPONS` and the loadout UI; retail publishes this from the factory starting-weapons configuration rather than the disabled-choice mask. | `F:references/hlil/quakelive/qagamex86.dll/qagamex86.dll.bndb_hlil_split/qagamex86.dll.bndb_hlil_part02.txt†L10997-L11005` |
