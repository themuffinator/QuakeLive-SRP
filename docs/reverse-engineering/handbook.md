...
| Native shim prototyping | [Native Prototype Shim Notes](./native-shim.md) | [`src-re/prototypes/common/native_shim.c`](../../src-re/prototypes/common/native_shim.c), [`src-re/prototypes/`](../../src-re/prototypes/), [`logs/re/native-shim.log`](../../logs/re/native-shim.log) |
...
* **Gameplay prototypes:** C99 reconstructions and shims under [`src-re/prototypes/`](../../src-re/prototypes/) with logging output at [`logs/re/native-shim.log`](../../logs/re/native-shim.log).
