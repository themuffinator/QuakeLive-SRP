...
| Connection auth hooks + SteamID caching | ⚠️ In Progress | `src/code/game/g_client.c`, `src/code/game/g_local.h` | `references/hlil/quakelive/qagamex86.dll/sully_interpreted/functions/g_client/ClientConnect.md` | Backend Integrations (@services-team) |
