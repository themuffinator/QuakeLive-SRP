...
- Expand local/runtime guards so parity builds fail fast when extra non-retail runtime DLLs are introduced alongside the launcher payload.【F:docs/platform/retail-dependencies.md†L57-L79】
