 ...
 *
 * Functions decompiled: top 177 by body size
 * Symbol map coverage : 275 / 276 FUN_ tokens resolved
 *
...

{
  ...
  if (((uVar6 != 0) || ((uStack_1010 & 0xfe) != 0)) || ((uStack_1010 & 0x1f00) != 0)) {
    ...
    if (uVar6 != 0) {
      ...
      UI_DrawHandlePic(fStack_1014,fStack_101c + (float)_DAT_10029260,_DAT_1002936c,_DAT_1002936c,uVar4)
      ;
...
void Asset_Parse(undefined4 param_1)
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      ...
      if (iVar1 == 0) {
        ...
        if ((iVar1 == 0) || (iVar1 = PC_Int_Parse(), iVar1 == 0)) goto LAB_10004ae2;
...
LAB_10004a6b:
                      ...
                      if (iVar1 != 0) {
                        iVar1 = Q_stricmpn();
                        if (((iVar1 == 0) || (iVar1 = Q_stricmpn(), iVar1 == 0)) ||
                           (iVar1 = Q_stricmpn(), iVar1 == 0)) goto LAB_10004a6b;
                        iVar1 = Q_stricmpn();
...
LAB_1000e1a4:
      ...
      if (DAT_10765618 < DAT_107644a0) {
        *(int *)(pcVar9 + 0x80) = DAT_10746428;
        ...
        Com_sprintf(&DAT_1076669c + DAT_10766ae0 * 0x40,0x40,"searching %d/%d...",DAT_10765618,
                     iVar2);
      }
    }
...

{
  ...
  if ((param_3 != 0) && ((*(uint *)(param_1 + 0x48) & 0x200000) == 0)) {
    uVar8 = Rect_ContainsPoint((float)*(int *)(DAT_106b40d0 + 0xf0),(float)*(int *)(DAT_106b40d0 + 0xf4));
...
void UI_DrawStartingWeapons(float param_1,float param_2,undefined4 param_3)
...
void __fastcall UI_RegisterClientModelname(undefined4 param_1,undefined4 param_2,int *param_3,char *param_4)
...
void Item_TextField_HandleKey(int param_1,int param_2)

{
  ...
  if (((((param_1 == 9) || (param_1 == 0x85)) || (param_1 == 0xa7)) &&
      (iVar6 = Menu_SetNextCursorItem(), iVar6 != 0)) &&
     ((*(int *)(iVar6 + 0x110) == 4 || (*(int *)(iVar6 + 0x110) == 9)))) {
    DAT_106b40e0 = iVar6;
  }
  if (((param_1 == 0x84) || (param_1 == 0xa1)) &&
     ((iVar6 = Menu_SetPrevCursorItem(), iVar6 != 0 &&
      ((*(int *)(iVar6 + 0x110) == 4 || (*(int *)(iVar6 + 0x110) == 9)))))) {
    DAT_106b40e0 = iVar6;
  }
LAB_10018ab7:
...

{
  ...
  if (local_1510 < 5) {
    Text_PaintCenter_AutoWrapped(_DAT_100294c8,_DAT_10029544,_DAT_10029548,_DAT_1002951c,DAT_10029328,auStack_d04);
  }
        ...
        if (0 < *(int *)(iVar7 + 0x180)) {
          do {
            ...
            if (((*(int *)(iVar7 + iStack_468 * 4) != 0) && (iVar4 = Q_stricmpn(), iVar4 == 0)) &&
               (iVar4 = Menu_FindItemByName(param_1,*(undefined4 *)(iVar7 + 0x80 + iVar10 * 4)), iVar4 != 0
               )) {
...
void UI_ParseMenu(undefined4 param_1)
...
void __thiscall UI_ParseAnimationFile(undefined4 param_1,void *param_2)
...
void __fastcall Menu_Paint(int param_1,undefined4 *param_2)
...
void Text_PaintCenter_AutoWrapped(float param_1,float param_2,float param_3,float param_4,float param_5,
                 char *param_6)
...

{
  ...
  if (DAT_107644b8 != 0) {
    ...
    if ((int)&DAT_107644d0 + iVar4 != 0) {
      Text_Paint_Limit((float)DAT_107644c0,(unaff_EBX[3] + unaff_EBX[1]) - (float)_DAT_10029268,param_1,
                   param_2,(int)&DAT_107644d0 + iVar4);
      iVar4 = DAT_107644c8;
    }
    if (-1 < DAT_107644c4) {
      Text_Paint_Limit((float)DAT_107644c4,(unaff_EBX[3] + unaff_EBX[1]) - (float)_DAT_10029268,param_1,
...
void UI_LoadArenasFromFile(undefined4 param_1,int param_2)
...

{
  ...
  iVar3 = DAT_106b40a8;
  uVar4 = va("%s-%i, %i at %i:%i",(&PTR_DAT_1002adf4)[iStack_18],uStack_1c,
...
void Item_Parse(char *param_1,undefined4 param_2)
...
void Text_PaintWithCursor(float param_1,float param_2,undefined4 param_3,float param_4,undefined4 param_5,
...
void Menu_Parse(undefined4 param_1,undefined4 param_2)
...
void __fastcall UI_RegisterClientSkin(undefined4 param_1,char *param_2,int param_3,undefined4 param_4)
...
void __thiscall Info_SetValueForKey(char *param_1,char *param_2)
    ...
    do {
      ...
      if (iVar3 != 0) {
        ...
        *(uint *)(unaff_EDI + 0x48) = *(uint *)(unaff_EDI + 0x48) & 0xfffffff9;
        ...
        Menu_HandleMouseMove(puVar1,(float)*(int *)(DAT_106b40d0 + 0xf0),
                     (float)*(int *)(DAT_106b40d0 + 0xf4));
...
void __thiscall Item_SetFocus(int param_1,undefined4 param_2,undefined4 param_3)
...
void Menu_TransitionItemByName(undefined4 param_1,float param_2,float param_3,float param_4,float param_5,
...
void ItemParse_cvarPreset(int param_1,undefined4 param_2)
...
void __fastcall Menu_ClearFocus(int param_1)
...

{
  ...
  if (param_1 != 0) {
    ...
    local_14 = local_14 - local_c;
    if ((*(byte *)(param_1 + 0x17c) & 3) != 0) {
      iVar1 = Item_EnableShowViaCvar(1);
      if (iVar1 == 0) goto LAB_10017b36;
    }
    if ((*(byte *)(param_1 + 0x17c) & 0xc) != 0) {
      iVar1 = Item_EnableShowViaCvar(4);
      if (iVar1 == 0) goto LAB_10017b36;
    }
...

{
  ...
  case 6:
  case 9:
    uVar1 = Item_ListBox_OverLB((float)*(int *)(DAT_106b40d0 + 0xf0),(float)*(int *)(DAT_106b40d0 + 0xf4));
    if ((uVar1 & 0x1800) != 0) {
  ...
  case 10:
  case 0xe:
    uVar1 = Item_Slider_OverSlider((float)*(int *)(DAT_106b40d0 + 0xf0),(float)*(int *)(DAT_106b40d0 + 0xf4));
    if ((uVar1 & 0x2000) == 0) {
      return;
    }
...
void Menus_ActivateByName(int param_1)
...
void Item_EnableShowViaCvar(uint param_1)
...
void ItemParse_cvarStrList(int param_1,undefined4 param_2)
...
void ItemParse_cvarFloatList(int param_1,undefined4 param_2)
...
void __fastcall Info_ValueForKey(char *param_1)
  ...
  do {
    ...
    if ((((*(uint *)(iVar3 + 0x48) & 0x100004) != 0) && ((*(uint *)(iVar3 + 0x48) & 0x10) == 0)) &&
      ...
      if ((*(int *)(iVar3 + 0x110) != 0) || (*(int *)(iVar3 + 0x130) == 0)) {
        if (((*(byte *)(iVar3 + 0x17c) & 0xc) != 0) && (iVar1 = Item_EnableShowViaCvar(4), iVar1 == 0)) {
          return 0;
        }
        return 1;
      }
...
UI_OwnerDrawHandleKey(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,int param_5
            )
...
void Parse_forecolor(int param_1,undefined4 param_2)
  ...
  if (*(int *)(unaff_ESI + 0x114) < *(int *)(unaff_ESI + 0x10c)) {
    do {
      *(int *)(unaff_ESI + 0x114) = *(int *)(unaff_ESI + 0x114) + 1;
      ...
      iVar2 = Item_SetFocus((float)*(int *)(DAT_106b40d0 + 0xf0),(float)*(int *)(DAT_106b40d0 + 0xf4)
                          );
      if (iVar2 != 0) {
  ...
  if (-1 < *(int *)(unaff_ESI + 0x114)) {
    do {
      ...
      *piVar1 = *piVar1 + -1;
      ...
      iVar3 = Item_SetFocus((float)*(int *)(DAT_106b40d0 + 0xf0),(float)*(int *)(DAT_106b40d0 + 0xf4)
                          );
      if (iVar3 != 0) {
        Menu_HandleMouseMove();
        return *(undefined4 *)(unaff_ESI + 0x154 + *(int *)(unaff_ESI + 0x114) * 4);
...
void ItemParse_cvar(int param_1,undefined4 param_2)
    ...
    if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
        ...
        if ((pcVar1 != (char *)0x0) && (*pcVar1 != '\0')) {
          ...
          if (iVar3 != 0) {
            Menu_TransitionItemByName(*(undefined4 *)(param_1 + 0x134),local_10,local_c,local_8,local_4,local_20,
...
void Item_Multi_Setting(int param_1)
      ...
      do {
        if (*(int *)(iVar1 + 0x184) == 0) {
          if ((float10)*pfVar5 == fVar6) break;
                ...
                (iVar3 = Q_stricmpn(), fVar6 = extraout_ST0, iVar3 == 0)) break;
        iVar4 = iVar4 + 1;
        pfVar5 = pfVar5 + 1;
      } while (iVar4 < iVar2);
    }
...
void Item_Multi_FindCvarByValue(int param_1)
...
void Parse_backcolor(int param_1,undefined4 param_2)
...
void Parse_bordercolor(int param_1,undefined4 param_2)
...
void MenuParse_focuscolor(int param_1,undefined4 param_2)
...
void MenuParse_disablecolor(int param_1,undefined4 param_2)
...
void PC_Color_Parse(undefined4 param_1)
...
void MenuParse_font(int param_1,undefined4 param_2)
...
void ItemParse_asset_model(int param_1,undefined4 param_2)
...
void UI_MapCountByGameType(int param_1)
